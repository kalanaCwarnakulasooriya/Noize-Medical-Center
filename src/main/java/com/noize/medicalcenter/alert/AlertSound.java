        ...
        try {
            ...
            switch (sound) {
                case INVALID:
                    ...
                    stopPreviousSound(); // Ensure no overlap
                    mediaPlayer = new MediaPlayer(media);
                    mediaPlayer.play();
                    break;

                case CONFIRM:
//                    resource = getClass().getResource("/sounds/confirmSound.mp3");
//                    if (resource == null) {
//                        throw new RuntimeException("Sound file not found: /sounds/confirmSound.mp3");
//                    }
//
//                    media = new Media(resource.toExternalForm());
//                    stopPreviousSound();
